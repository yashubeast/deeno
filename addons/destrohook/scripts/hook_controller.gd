...
@export var launch_action_name: String = "shoot"## Input Map action name that triggers hook's launch; default left mouse button

@export var retract_action_name: String = "shoot"## Input Map action name that triggers hook's retraction; default left mouse button
...
@export var shorten_action_name: String = "zoom_out"## Input Map action name that decreases the length of the rope rest_length; default mouse scroll down
@export var extend_action_name: String = "zoom_in"## Input Map action name that increases the length of the rope rest_length; default mouse scroll up
